...
function updateMenu(res) {
    ...
    res.locals.menu.push({
        title: _('Lists'),
        url: config.www.baseDir + '/lists',
        key: 'lists'
    }, {
        title: _('Templates'),
        url: config.www.baseDir + '/templates',
        key: 'templates'
    }, {
        title: _('Campaigns'),
        url: config.www.baseDir + '/campaigns',
        key: 'campaigns'
    }, {
        title: _('Automation'),
        url: config.www.baseDir + '/triggers',
        key: 'triggers'
    });
    ...
    if (config.reports && config.reports.enabled === true) {
        res.locals.menu.push({
            title: _('Reports'),
            url: config.www.baseDir + '/reports',
            key: 'reports'
        });
    }
}
