...
function sendSubscriptionConfirmed(list, email, subscription, callback) {
    const relativeUrls = {
        preferencesUrl: config.www.baseDir + '/subscription/' + list.cid + '/manage/' + subscription.cid,
        unsubscribeUrl: config.www.baseDir + '/subscription/' + list.cid + '/unsubscribe/' + subscription.cid
    };
...
function sendConfirmAddressChange(list, email, cid, subscription, callback) {
    ...
    const relativeUrls = {
        confirmUrl: config.www.baseDir + '/subscription/confirm/change-address/' + cid
    };
...
function sendConfirmSubscription(list, email, cid, subscription, callback) {
    ...
    const relativeUrls = {
        confirmUrl: config.www.baseDir + '/subscription/confirm/subscribe/' + cid
    };
...
function sendConfirmUnsubscription(list, email, cid, subscription, callback) {
    ...
    const relativeUrls = {
        confirmUrl: config.www.baseDir + '/subscription/confirm/unsubscribe/' + cid
    };
...
function sendUnsubscriptionConfirmed(list, email, subscription, callback) {
    const relativeUrls = {
        subscribeUrl: config.www.baseDir + '/subscription/' + list.cid + '?cid=' + subscription.cid
    };
